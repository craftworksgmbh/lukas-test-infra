...
import at.craftworks.lukas.test.model.AbstractDomainEntity;
...
@Configuration
@EnableJpaRepositories("at.craftworks.lukas.test.repository")
...
public class PersistenceTestConfig {
    ...
    public DataSource dataSource() {
        PostgreSQLContainer postgres = new PostgreSQLContainer("postgres:13")
                .withDatabaseName("lukastest")
                .withPassword("lukastest")
                .withUsername("lukastest");
