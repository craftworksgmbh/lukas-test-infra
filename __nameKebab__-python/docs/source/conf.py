...
# __projectSnake__ documentation build
...
from __projectSnake__ import __version__ as release

# -- Project information -----------------------------------------------------

project = "__projectSnake__"
author = "Kedro"
...
htmlhelp_basename = "__projectSnake__doc"
...
latex_documents = [
    (
        master_doc,
        "__projectSnake__.tex",
        "__projectSnake__ Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "__projectSnake__",
        "Project __projectSnake__ codebase.",
        "Data-Science",
    )
]
